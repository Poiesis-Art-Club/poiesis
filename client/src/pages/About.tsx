...
export const teamMembers = [
  { name: "Hiba", role: "Founder", image: assetPath("/manus-storage/Hiba_founder_f423ee61.png"), optimizedImage: assetPath("/manus-storage/Hiba_founder-card_22d8bfb3.webp"), portraitWidth: 299, description: "A dark-academic heart with a soft centre: reading, sketching, writing, anime, metal, rock and jazz.", tags: ["Reading", "Sketching", "Writing"], motifImage: assetPath("/manus-storage/hiba-ines-quill_76a98b44.jpg"), motifImageAlt: "Public-domain quill and ink illustration", motifs: [{ icon: BookOpenText, label: "Reading" }, { icon: PencilLine, label: "Sketching" }, { icon: Music2, label: "Jazz" }] },
  { name: "Chama", role: "Video Editor", image: assetPath("/manus-storage/Chama_videoeditorpng_9f205213.png"), optimizedImage: assetPath("/manus-storage/Chama_videoeditor-card_f1c140b6.webp"), portraitWidth: 235, description: "A keychain collector with a restless eye for video, photography, music, theatre and drawing.", tags: ["Video", "Photography", "Theatre"], motifImage: assetPath("/manus-storage/chama-camera-obscura_64ce7e4c.jpg"), motifImageAlt: "Public-domain camera obscura illustration", motifs: [{ icon: Camera, label: "Photography" }, { icon: Music2, label: "Music" }, { icon: PencilLine, label: "Drawing" }] },
  { name: "Alae", role: "Logistics Coordinator", image: assetPath("/manus-storage/Alae_logisticspng_0e1d9b30.png"), optimizedImage: assetPath("/manus-storage/Alae_logistics-card_4b1c9b99.webp"), portraitWidth: 208, description: "The planner behind the scenes, bringing travel, sport, reading and music into the work of gathering people.", tags: ["Planning", "Travel", "Music"], motifImage: assetPath("/manus-storage/alae-world-map_46958d8b.jpg"), motifImageAlt: "Public-domain seventeenth-century world map", motifs: [{ icon: CalendarDays, label: "Planning" }, { icon: Map, label: "Travel" }, { icon: Dumbbell, label: "Sport" }] },
  { name: "Adam", role: "Graphic Designer", image: assetPath("/manus-storage/Adam_graphicdesignerpng_dd9b4b54.png"), optimizedImage: assetPath("/manus-storage/Adam_graphicdesigner-card_1aaf129c.webp"), portraitWidth: 212, description: "A guitar player and visual maker who knows sign language and still draws in MS Paint.", tags: ["Design", "Guitar", "Visual play"], motifImage: assetPath("/manus-storage/adam-harp-guitar_8c8c3f73.jpg"), motifImageAlt: "Public-domain harp-guitar patent drawing", motifs: [{ icon: Guitar, label: "Guitar" }, { icon: PencilLine, label: "Drawing" }, { icon: Palette, label: "Design" }] },
  { name: "Nael", role: "Website Creator", image: assetPath("/manus-storage/Nael Website creator.png"), optimizedImage: assetPath("/manus-storage/Nael Website creator.png"), portraitWidth: 300, description: "A curious maker who plays drums and guitar, wants to learn everything and loves computers, music, drawing, design, robotics, marine biology and aquatic life.", tags: ["Drums & guitar", "Robotics", "Marine biology"], motifImage: assetPath("/manus-storage/adam-harp-guitar_8c8c3f73.jpg"), motifImageAlt: "Public-domain harp-guitar patent drawing", motifs: [{ icon: Music2, label: "Music" }, { icon: Palette, label: "Design" }, { icon: Search, label: "Learning" }] },
  { name: "Ines", role: "Photographer", image: assetPath("/manus-storage/Ines_photographer_92214f66.png"), optimizedImage: assetPath("/manus-storage/Ines_photographer-card_5818effc.webp"), portraitWidth: 254, description: "A curious collector of mystery stories, details and ideas worth following all the way down.", tags: ["Photography", "Research", "Stories"], motifImage: assetPath("/manus-storage/hiba-ines-quill_76a98b44.jpg"), motifImageAlt: "Public-domain quill and ink illustration", motifs: [{ icon: Camera, label: "Photography" }, { icon: Search, label: "Research" }, { icon: Music2, label: "Music" }] },
  { name: "Sara", role: "Illustrator", image: assetPath("/manus-storage/Sara_illustratorpng_c78ed546.png"), optimizedImage: assetPath("/manus-storage/Sara_illustrator-card_2508297d.webp"), portraitWidth: 226, description: "A thoughtful illustrator who wants to create a manga and draws energy from J-pop, anime and games.", tags: ["Illustration", "Manga", "J-pop"], motifImage: assetPath("/manus-storage/sara-cat-fiddle_c267547a.jpg"), motifImageAlt: "Public-domain cat and fiddle illustration", motifs: [{ icon: PencilLine, label: "Drawing" }, { icon: Gamepad2, label: "Games" }, { icon: Cat, label: "Cats" }] },
  { name: "Malak", role: "Poiesis Member", image: assetPath("/manus-storage/Malakpng_33d37f16.png"), optimizedImage: assetPath("/manus-storage/Malak-card_b9a4dc09.webp"), portraitWidth: 229, description: "A many-hobbies person with room for music, digital art, cooking and sport.", tags: ["Digital art", "Music", "Cooking"], motifImage: assetPath("/manus-storage/malak-cooking-utensils_04fa0d42.jpg"), motifImageAlt: "Public-domain cooking utensils illustration", motifs: [{ icon: Palette, label: "Digital art" }, { icon: CookingPot, label: "Cooking" }, { icon: Dumbbell, label: "Sport" }] },
  { name: "Yasmine", role: "Poiesis Member", image: assetPath("/manus-storage/Yasminepng_953e7809.png"), optimizedImage: assetPath("/manus-storage/Yasmine-card_6a3a1c3a.webp"), portraitWidth: 253, description: "A dreamer drawn to nature and landscapes, with a green thread through a love for art.", tags: ["Nature", "Landscapes", "Art"], motifImage: assetPath("/manus-storage/yasmine-landscape_9552ca6b.jpg"), motifImageAlt: "Public-domain landscape engraving", motifs: [{ icon: Leaf, label: "Nature" }, { icon: Mountain, label: "Landscapes" }, { icon: Palette, label: "Art" }] },
];
